...
public class AppointmentController {
	...
	public ResponseEntity<?> bookAppointmentForPatient(@PathVariable Long doctorId, @PathVariable Long patientId,
		...
		ResponseEntity<?> entity =ResponseEntity.ok(appointmentService.bookAppointmentForPatient(doctorId, patientId, time));
	...
	public void cancelAppointment(@PathVariable Long appointmentId) {
		System.out.println("in appointment controller id = "+appointmentId);
